...
\subsection{Perplexity based fake news detection}
...
\begin{itemize}
\item $PPL_{GPT2-B}$ : a single-parameter classifier based on perplexity from GPT2-base (Radford et al., 2019) (unidirectional LM)
\item $PPL_{BERT-B}$ : a single-parameter classifier based on perplexity from BERT-base (Devlin et al., 2019) (Masked LM)
\end{itemize}
