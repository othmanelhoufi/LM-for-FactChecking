...
\multirow{3}{*}{\textit{XLNET-base-cased}} & SUPPORTS & 0.53 & 0.81 & 0.64 & \multirow{3}{*}{0.61} & \multirow{3}{*}{0.63} & \multirow{3}{*}{0.61} & \multirow{3}{*}{0.60} \\
 ...
 & NEI & 0.63 & 0.43 & 0.51 &  &  &  &  \\
\bottomrule
\textbf{Related works	} & \textbf{Label} & \textbf{prec} & \textbf{recall} & \textbf{~f1} & \textbf{accuracy} & \textbf{macro prec} & \textbf{macro recall} & \textbf{macro f1} \\ 
\toprule
...
\vspace{0.4cm}
\caption{Classification metrics for each fine-tuned LM.}
\end{table*}
